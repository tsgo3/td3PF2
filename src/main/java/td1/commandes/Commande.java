...
public class Commande {
    ...
    public Function<Paire<Produit, Integer>, String> formatteurLigne = ligne -> String.format("Le produit %s  coûte %d",  ligne.fst(), ligne.snd());
    ...
    public <T, U> Map<T, List<U>> regrouper(List<Paire<T, U>> li)
    {
        Map<T, List<U>> rtr = new HashMap<>();
        for(Paire<T, U> li2 : li)
        {
            rtr.computeIfAbsent(li2.fst(),n -> rtr.put(li2.fst(), (List<U>) li2.snd()) );
        }
